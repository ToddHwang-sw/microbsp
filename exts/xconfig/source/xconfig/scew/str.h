...
#define scew_strcasecmp(s1, s2) wcscasecmp (s1, s2)
...
#define scew_strtok(s1, s2, p)  wcstok(s1, s2, p)
#define scew_strncmp(s1, s2, n) wcsncmp(s1, s2, n)
#define scew_strtol(s1, s2, b)  wcstol(s1, s2, b)
#define scew_strtod(s1, s2) wcstod(s1, s2)
#define scew_strchr(s, c) wcschr(s, c)
...
#define scew_strcasecmp(s1, s2) strcasecmp (s1, s2)
...
#define scew_strtok(s1, s2, p)  strtok(s1, s2)
#define scew_strncmp(s1, s2, n) strncmp(s1, s2, n)
#define scew_strtol(s1, s2, n)  strtol(s1, s2, n)
#define scew_strtod(s1, s2) strtod(s1, s2)
#define scew_strchr(s, c) strchr(s, c)
